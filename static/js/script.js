...
$(function () {
  ...
  $(".tab-item").click(function () {
    if (!$(this).hasClass("selected")) {
      ...
      var items = $(this).attr('module-tab-items');
      var index = $(this).index();
      $('.tab-list',items).eq(index).addClass("selected").siblings().removeClass("selected");
      $('.tab-list',items).eq(index).find(".lazyload").lazyload();
